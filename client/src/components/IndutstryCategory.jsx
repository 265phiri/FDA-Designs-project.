...
export const IndustryCategory = () => {
  ...
  return (
    ...
    <div className='relative overflow-x-auto w-screen h-screen'>
      <img src="https://images.unsplash.com/photo-1547895749-888a559fc2a7?q=80&w=1964&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" className='object-cover h-full w-full' loading='lazy'/> 
      ...
      <div className="absolute bg-black opacity-60 h-full w-full top-0 right-1/2 translate-x-1/2 font-urbanist text-white">
        <div className="font-semibold mx-auto text-white  w-fit mt-40 xs:mt-72 md:mt-32">
          <p className='font-bold xl:text-[200px]  xs:text-center xs:text-6xl xs:font-light xs:mb-10 md:text-[120px] lg:text-[150px] md:pt-60 xl:pt-20'>Industrial</p>
